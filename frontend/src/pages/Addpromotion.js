...
const Addpromotion = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        const payload = {"name":name ,"description":description,"start_date":start_date,
        ...
        const response = await axiosInstance.post('/restaurent/promotion', payload , {
        headers: {
        ...
        navigate('/promotion', {state: {message: 'Promotion Added!'}})
        }
        // Handle success
    } catch (error) {
