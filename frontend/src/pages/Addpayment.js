...
const Addpayment = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        const payload = {"amount":amount , "payment_method":payment_method,"card_holder_name":card_holder_name, 
          "card_number":card_number, "order_bill":order_bill}
        
        const response = await axiosInstance.post('/restaurent/payment', payload , {
        headers: {
        ...
        navigate('/payment', {state: {message: 'Payment Added!'}})
        }
        // Handle success
    } catch (error) {
  ...
  return (
    <div class='container' style={{ marginLeft: '200px' }}>
        <h2 class='mt-4'>Add Payment Here :</h2>
